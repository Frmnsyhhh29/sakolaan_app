...
class NilaiEditPage extends ConsumerStatefulWidget {
  final String nilaiId;

  const NilaiEditPage({super.key, required this.nilaiId});

  @override
  ConsumerState<NilaiEditPage> createState() => _NilaiEditPageState();
}

class _NilaiEditPageState extends ConsumerState<NilaiEditPage> {
...
>>>>>>> Stashed changes
  ...
  Future<void> _loadNilaiData() async {
    ...
    try {
      ...
      setState(() {
        _selectedSiswaId = nilai.siswaId;
        _selectedMapelId = nilai.mapelId;
        _semester = nilai.semester;
        _tahunAjaran = nilai.tahunAjaran;
        ...
        _catatanController.text = nilai.catatan ?? '';
        _hitungNilaiAkhir();
      });
    } catch (e) {
      _showError('Gagal memuat data nilai: $e');
    } finally {
...
>>>>>>> Stashed changes
    ...
    try {
      ...
      final success = await ref.read(nilaiProvider.notifier).updateNilai(int.parse(widget.nilaiId), nilai);
      ...
      if (success && mounted) {
        ...
        _showError('Gagal mengupdate nilai');
      }
    } catch (e) {
      _showError('Error: $e');
    } finally {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Edit Nilai', style: TextStyle(fontWeight: FontWeight.w600)),
      ),
      body: _isLoading
                        ...
                        Card(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                const Text('Informasi Siswa & Mata Pelajaran', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                                ...
                                DropdownButtonFormField<int>(
                                  ...
                                  items: _siswaList.map((siswa) => DropdownMenuItem<int>(value: siswa['id'], child: Text(siswa['nama']))).toList(),
                                ...
                                DropdownButtonFormField<int>(
                                  ...
                                  items: _mapelList.map((mapel) => DropdownMenuItem<int>(value: mapel['id'], child: Text(mapel['nama']))).toList(),
                                  ...
                                  children: [
                                    Expanded(
                                      child: DropdownButtonFormField<String>(
                                        decoration: InputDecoration(labelText: 'Semester', border: OutlineInputBorder(borderRadius: BorderRadius.circular(8))),
                                        value: _semester,
                                    ...
                                    Expanded(
                                      child: DropdownButtonFormField<int>(
                                        decoration: InputDecoration(labelText: 'Tahun Ajaran', border: OutlineInputBorder(borderRadius: BorderRadius.circular(8))),
                                        value: _tahunAjaran,
                        ...
                        Card(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Text('Input Nilai', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                                const SizedBox(height: 16),
...
>>>>>>> Stashed changes
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      const Text('Nilai Akhir:', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                                      Row(
                                        children: [
                                          Text(_nilaiAkhir.toStringAsFixed(2), style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.teal.shade700)),
                                          const SizedBox(width: 12),
                                          Container(
                                            padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                                            decoration: BoxDecoration(color: _getGradeColor(_grade), borderRadius: BorderRadius.circular(6)),
                                            child: Text(_grade, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
                                          ),
                                        ],
                                      ),
                                    ],
                        ...
                        ElevatedButton(
                          ...
                          child: _isLoading
                              ...
                              : const Text('Update Nilai', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                        ),
                      ],
                    ),
                  ),
